export const templateData = [
  ...
  },
  {
    ...
    content: '<h1>Bienvenue {{userName}} !</h1><p>Pensez à compléter votre profil pour pouvoir postuler à un événement.</p>',
    metadata: {
      variables: {
  ...
  },
  {
    ...
    type: 'participation',
    channel: 'sms',
    content: 'Votre participation à {{eventName}} le {{eventDate}} est acceptée. À bientôt !',
    metadata: {
      variables: {
        eventName: { type: 'string', required: true },
  ...
  },
  {
    ...
    content: 'N\'oubliez pas votre événement {{eventName}} demain à {{eventTime}}',
    metadata: {
      variables: {
        eventName: { type: 'string', required: true },
  ...
  },
  {
    ...
    content: '<h2>Événement annulé</h2><p>Nous sommes désolés de vous informer que l\'événement <strong>{{eventName}}</strong> prévu le {{eventDate}} a été annulé.</p><p>Raison : {{cancelReason}}</p>',
    metadata: {
      variables: {
        eventName: { type: 'string', required: true },
        eventDate: { type: 'string', required: true },
  ...
  },
  {
    ...
    content: 'Des détails de l\'événement {{eventName}} ont changé : {{changes}}',
    metadata: {
      variables: {
        eventName: { type: 'string', required: true },
  ...
  },
  {
    ...
    content: 'Nouvel événement {{eventName}} disponible le {{eventDate}} dans votre région',
    metadata: {
      variables: {
        eventName: { type: 'string', required: true },
        eventDate: { type: 'string', required: true }
  ...
  // ORGANISATEUR
  {
    ...
    content: 'Vous avez reçu une note de {{rating}}/5 pour l\'événement {{eventName}}',
    metadata: {
      variables: {
  ...
  },
  {
    ...
    type: 'participation',
    channel: 'webhook',
    content: '{"event": "participation_request", "volunteer": "{{volunteerName}}", "event_name": "{{eventName}}", "volunteer_id": {{volunteerId}}, "event_id": {{eventId}}}',
    metadata: {
      variables: {
        volunteerName: { type: 'string', required: true },
        eventName: { type: 'string', required: true },
